...
public class ReentrantLockExample {
    public static void main(String[] args) throws InterruptedException {
        ...
        ReentrantPipeline<Person.PersonRoot> pipeline = new ReentrantPipeline<>();
    ...
    private static synchronized void iterator(List<Person> data, ReentrantPipeline<Person.PersonRoot> pipeline) throws InterruptedException {
